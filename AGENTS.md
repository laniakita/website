When working on UI components, always use the `laniakita-com-sb` MCP tools to access Storybook's component and documentation knowledge before answering or taking any action.
