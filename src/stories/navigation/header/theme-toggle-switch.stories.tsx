...
import { ThemeStoreProvider, useThemeStore } from '@/features/providers/theme-store-provider';
...
const ThemeSwitchWrapper = () => (
  <ThemeStoreProvider>
    <div className="flex flex-col items-center gap-4 p-8 border rounded-lg bg-background text-foreground">
      <p className="text-sm text-muted-foreground">The switch syncs with local storage and root document classes.</p>
      <ThemeToggleSwitch />
    </div>
  </ThemeStoreProvider>
);
