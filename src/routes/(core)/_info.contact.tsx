...
const getContactPage = createServerFn({ method: "GET" }).handler(async () => {
	const page = pagesSource.getPage(["contact"]);
...
export const Route = createFileRoute("/(core)/_info/contact")({
	loader: async () => {
