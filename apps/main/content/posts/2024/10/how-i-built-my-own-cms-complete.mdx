...
type: Post
createdAt: 2024-10-08T06:18:55Z
lastModified: 2024-10-17T02:33:45Z
catSlugs:
  - meta
  - backend
  - technical-summary
...
<summary>Choosing Turso over Cloudflare's D1</summary>
...
The idea was that the authors, featured_images, and tagSlugs tables would respectively create one-many[^59], and many-many[^59] relations to the posts table. Something like this:

![Entity Relationship diagram showing 1:M (authors, featured_images), and M:M (tagSlugs). The latter made possible with a junction table (posts_to_tagSlugs)](../../../../public/images/oc/2024/10/cms-relations-diagram.jpg)
...
As far as relations go, I'm using drizzles relations[^65] feature, and creating relational tables for both _one-to-many_ (`authors`, `featured_images`) and _many-to-many_ (`tagSlugs`) relations. In truth, this was somewhat _extra_, since I had foreign keys available to me on `turso`, but I was curious to know what `drizzle` was capable of, and this is one such addition that `drizzle` brings to the table (no pun intended \>.\<), beyond (most) vanilla SQL functions.
...
<summary>Prepping for ISR</summary>
...
<summary>[INFO]: `fetch-mdx.ts`</summary>
...
<summary>[INFO]: `matterProcessor()`</summary>
...
<summary>Performance vs Readability</summary>
...
<summary>
  [INFO]: <code>bun-db-funcs.ts</code>
</summary>
...
<summary>
  [INFO]: <code>node-db-funcs.ts</code>
</summary>
...
<summary>
  [INFO]: <code>contentlayer.config.ts</code>
</summary>
...
<summary>
  [INFO]: <code>image-process.ts</code>
</summary>
