...
type: Post
createdAt: 2025-03-05T07:25:49Z
catSlugs:
  - meta
tagSlugs:
  - turborepo
...
imageSrc: ../../../../public/images/non-oc/artem-horovenko-pipes.jpg
...
![Screenshot of Production Build #41 attempt 02, showing a locked sst state error, failing the Deploy step](../../../../public/images/oc/2025/03/prod-build-log-41-attmpt-2.png)
...
![Screenshot of Production Build #41 attempt 03, getting stuck building @website/web.](../../../../public/images/oc/2025/03/prod-build-log-41-attempt-3.png)
...
![Screenshot of Production Build #41 attempt 04, showing the attempt at lines 51-53 to build @website/web, and the inevitable hang at lines 74 where it finished creating the MonitorMetricsSchedule scheduler](../../../../public/images/oc/2025/03/prod-build-log-41-hang.png)
...
![Screenshot of Production Build #42, showing the same hang at lines 74-75 where it finishes creating the MonitorMetricsSchedule scheduler before getting stuck](../../../../public/images/oc/2025/03/prod-build-log-42-hang.png)

_No dice._ As a follow-up, I wondered if re-creating `bun.lock` might help, so I tried that too.

![Screenshot of Production Build #43, stuck in the same place](../../../../public/images/oc/2025/03/prod-build-log-43.png)
...
![Screenshot of Production Build #44, showing a locked sst state error, (again) failing the Deploy step](../../../../public/images/oc/2025/03/prod-build-log-44-oops.png)

_Oops_. I correct the _Lock_ once more, and sent through my final _hail mary_ attempt for the evening.

![Screenshot of Production Build #45, hanging once more at line 73-75, with the canceled message below it.](../../../../public/images/oc/2025/03/prod-build-log-45-sigh.png)
...
![Screenshot of production build #46. Showing a very familiar problem (hanging).](../../../../public/images/oc/2025/03/prod-build-log-46.png)
...
![Screenshot showing prebuild and test tasks completed, but getting stuck on MonitorMetricsSchedule again](../../../../public/images/oc/2025/03/prod-build-log-47.png)
...
![Screenshot of production build #48, showcasing a successful run with all job steps complete.](../../../../public/images/oc/2025/03/prod-build-log-48-success.png)
...
![Screenshot of the process it took to get the dev action working.](../../../../public/images/oc/2025/03/a-new-adventure.png)
...
![Screenshot showing a perfect run from Dev Build Action #7. Every step has a check mark, finishing in just under three minutes.](../../../../public/images/oc/2025/03/dev-build-log-7-perfect.png)
...
![Screenshot of my commit into main with the message: refactor: test if sst deploy command hangs in CI. A green check mark appears below it with a 1/1 informing me that it completed the workflow successfully](../../../../public/images/oc/2025/03/a-perfect-test.png)

I then sent several more changes through, to test whether that was a fluke. It was not.

![Screenshot showing my latest commits all deployed perfectly, no hangups.](../../../../public/images/oc/2025/03/not-a-fluke.png)
