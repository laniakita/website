/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d7874681c4f031bf04125116fd23ea4d)
// Runtime types generated with workerd@1.20260811.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	BASE_DOMAIN: "laniakita.com" | "localhost";
	OG_AUTH_TOKEN: string;
	DOMAIN: string;
	CDN_DOMAIN: string;
	CDN_ORIGIN: string;
	VITE_APP_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_DOMAIN" | "OG_AUTH_TOKEN" | "DOMAIN" | "CDN_DOMAIN" | "CDN_ORIGIN" | "VITE_APP_URL" | "VITE_CDN" | "BUCKET_PUBLIC_URL" | "BUCKET_ENDPOINT" | "BUCKET_NAME" | "BUCKET_ACCESS_KEY_ID" | "BUCKET_SECRET_ACCESS_KEY" | "R2_CFAT">> {}
}
