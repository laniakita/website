    ...
    return allProjects
      ...
      .map((project, idx) =>
        <li
          ...
          className={`${visible ? 'motion-safe:animate-big-fade-in-up motion-safe:opacity-0' : 'motion-safe:animate-big-fade-down'} min-w-80 @3xl:min-w-96 overflow-hidden rounded-md border border-ctp-surface0 bg-ctp-base dark:bg-ctp-midnight motion-safe:simple-color-trans dark:border-ctp-base`}
