export default function FooterSubscribe() {
  return (
    <div className='relative z-10 flex w-full flex-col items-center justify-center px-2 py-4'>
      <div className='border-ctp-mauve bg-ctp-base flex size-full max-w-3xl flex-col gap-4 rounded-xl border p-4 supports-[text-wrap:pretty]:text-pretty'>
        ...
        <div className='simple-color-trans border-ctp-surface0 bg-ctp-mantle flex w-full flex-row items-center justify-between overflow-x-hidden rounded-lg border p-2 text-2xl font-thin shadow-inner'>
          <p className='break-all'>urEmail@address.com</p>
          <div className='color-trans-2 border-ctp-surface0 hover:bg-ctp-mauve hover:text-ctp-base hover:shadow-ctp-mauve/30 flex items-center justify-center rounded-xl border p-2 text-3xl hover:shadow-xl'>
