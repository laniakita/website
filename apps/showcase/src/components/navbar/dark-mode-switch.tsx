  ...
  return (
    <div className='s-slider' id='darkmode-switch'>
      <button
        ...
        onClick={handleClick}
        className='aria-checked-before:border-ctp-surface2 border-ctp-text/60 bg-ctp-overlay2/60 before:bg-ctp-base/90 aria-checked:border-ctp-surface2/60 aria-checked:bg-ctp-surface2/20 aria-checked:before:bg-ctp-midnight relative h-8 w-12 rounded-[1em] border shadow-inner before:shadow-md aria-checked:shadow-inner'
      />
    </div>
  );
}
