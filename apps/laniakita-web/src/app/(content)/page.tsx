    ...
    <div className='flex flex-row items-center gap-2'>
      {boxItems.map((item, idx) => (
        <Link
          ...
          href={item.url}
          className='color-trans-quick items-center justify-center text-ctp-text hover:text-ctp-pink dark:hover:text-ctp-sky md:text-ctp-subtext0'
          target='_blank'
  ...
  return (
    <main className='relative flex h-screen min-h-[40rem] w-full items-end justify-center'>
      ...
      <div className='z-10 flex size-full flex-col items-center justify-end'>
        <div className='simple-color-trans flex w-full flex-col items-center justify-center gap-6 border-t border-ctp-surface0 bg-ctp-base/80 p-10 backdrop-blur-md dark:bg-ctp-midnight/80 md:items-start'>
          ...
          <div className='simple-color-trans flex w-full items-center justify-between gap-4 rounded-md border border-ctp-pink bg-ctp-base/70 p-4 shadow-2xl backdrop-blur-md dark:border-ctp-sapphire/40 dark:bg-ctp-midnight/70 md:flex-row md:bg-ctp-base/60 md:p-2'>
