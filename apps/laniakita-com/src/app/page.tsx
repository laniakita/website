  ...
  return (
    <Scroller>
      <ThreeLayout camera={{ fov: 45 }}>
        <div className='motion-safe:simple-color-trans min-h-screen bg-ctp-base dark:bg-ctp-midnight'>
          <div
          ...
          >
              ...
              <div className='text-ctp-text opacity-0 motion-safe:animate-fade-in motion-reduce:opacity-100 '>
                <div className='w-fit'>
                  <div className='flex w-fit flex-col -space-y-1 pb-1 text-4xl font-black text-ctp-text md:space-y-0 md:pb-2'>
                    <h1 className='max-w-max motion-safe:hidden'>
                      I create web app & digital experiences that delight.
                    </h1>
            ...
            <div className='w-full max-w-5xl px-4'>
              <div className='w-full rounded-2xl bg-gradient-to-br from-ctp-pink to-ctp-mauve p-px shadow-xl shadow-ctp-mauve/30'>
                <div className='relative size-full h-[50vh] rounded-2xl bg-black p-3'>
                  <SceneOverlay />
              ...
              <p className='w-full  pt-4 italic supports-[text-wrap:pretty]:text-pretty [@media_(min-width:_350px)]:px-6'>
                Fig. 01 &mdash; <strong>Interactive greeter</strong>. Made with Three.js. 3D models by Rafael Rodrigues,
                and Kaine G. see:{' '}
            ...
            <div className='flex w-full max-w-5xl items-center justify-start'>
              {/*
              flex-col-reverse items-center justify-center gap-6 lg:flex-row-reverse lg:items-start lg:gap-0

              <div className='max-w-xl px-4'>
                <div className='flex size-full max-h-52 min-h-40 flex-col items-center justify-center rounded-2xl bg-gradient-to-br from-ctp-mauve to-ctp-pink p-px shadow-xl shadow-ctp-mauve/30'>
                ...
                <p className='w-full px-6 pt-4 italic supports-[text-wrap:pretty]:text-pretty lg:px-0'>
                  Fig. 02 &mdash; <strong>Lani&apos;s Social Media Accounts + RSS Subscribe Button</strong>. Made with
                  react + tailwindcss. Icons provided by Fontawsome and Phosphor.
                </p>
              </div>
              */}
              <div className='flex max-w-xl flex-col gap-4 [@media_(min-width:_350px)]:px-10'>
                ...
                <div className='flex flex-col gap-4 text-lg supports-[text-wrap:pretty]:text-pretty'>
                  <p className=''>
                    My name is Lani Akita and I create applications for the modern net. In my time I&apos;ve worked with
                    a lot of different tools and technologies (see:{' '}
                  ...
                  <p>
                    I mostly write TypeScript in combination with JavaScript libraries and (meta-)frameworks for use
                    with a Node runtime environment. Though, I&apos;m partial to Bun and its runtime environment,
                    especially when deploying apps on the Edge (i.e. Cloudflare Workers).
                  </p>

                  <p className=''>
                    When I&apos;m working, but not hacking away in a Neovim buffer, I&apos;m creating digital
                    illustrations in Krita with a graphics tablet. You can (soon) see my work strewn about this website
                    and on{' '}
