...
If you'd like to learn more, you should probably check out the [blog](/blog), and if you find it interesting, you might consider subscribing to the [RSS feed](/rss.xml) or supporting it by becoming a fan on [Patreon](https://patreon.com/Lani_Akita). You can also check out my socials, linked in the footer below, for the latest updates.
