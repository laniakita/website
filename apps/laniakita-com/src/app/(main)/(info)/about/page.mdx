export const metadata = {
  title: 'About Lani',
  description: 'This is the personal site and Full Stack Web Development blog of Lani Akita.',
  openGraph: {
    title: 'About Lani',
    description: 'This is the personal site and Full Stack Web Development blog of Lani Akita.'
  },
...
>**Addendum**: In my mind this section wasn't going to be so extensive. It was just supposed to give you a rough idea of what sort of developer I actually am, since Full-Stack could mean anything! 
>
>Also, this entire thing is only the highlights! There's a bunch of stuff I didn't even mention like build tools (Vite, Webpack, Esbuild, etc.) and package managers (npm, pnpm, bun), and editor tools like linters, formatters, debuggers, etc. I also neglected to talk about the nix-flakes I use to create isolated dev environments. I even forgot to talk about using Podman/Docker and Compose when I don't feel the need to deploy a minikube cluster on my Homelab.
>
>Aside, this pretty quickly became a gigantic list of some of the tools I've used in the past, and what I'm currently working with now (4/23/2024), and what I did/do with them. Since there's so much packed in here, you might find something cool you've never heard of, so maybe you'll get something out of it afterall. 
>
>~ Lani
...
I'm going to embarass myself for a little bit and tell you a bit about my workflow. Do note that just because I work this way, doesn't necessarily mean you should too, it's just how I prefer to do things.

- **OS**: I'm quite partial to NixOS (btw), because a single flake.nix declares all of my machines that either run NixOS or Nix the package manager. I can rapidly provision cloud VPSes/EC2 instances the exact same way.

- **DE/WM**: Because I tend to have multiple app windows open simultaneously, I find Sway WM (i3 but for wayland) quite useful.

- **Text Editor**: I use Nixvim (a Neovim distro that let's you configure it with Nix + raw lua strings), because I like knowing precisely how my tools work, especially the one I use the most. I also really like customizing such tools to my hearts content, without restriction. If you happen to use Neovim and also use Nix/NixOS, consider giving Nixvim a shot! ^-^

- **Linters**: An eslint config (now flatter) is in pretty much every project I do nowadays, and integrated with a tsconfig file. While not everyone finds linters (& their diagnostic errors/warnings)  useful, I like that it keeps my codebases consistent.  

- **Formatters**: I love prettier & prettierd. I often integrete the tailwindcss plugin in my .prettierrc to sort tailwind classnames. There's also something quite satisfying about triggering my formatting key map, and watching all my little spacing errors and inconsistent use of quotations suddenly become neat and uniform.
