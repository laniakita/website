...
const BotClickerScene = dynamic(() => import('@/components/canvas/scenes/bot-clicker/neil/main'), {
  ssr: false,
  loading: () => (
    <div className='absolute top-0 flex h-dvh max-h-[calc(100dvh-4rem)] w-full items-center justify-center lg:max-h-dvh'>
