...
As well, this particular bulb you're seeing is being rendered with a combination of Three.js + React Three Fiber + React Three Drei, rather than just the pure Three.js functions I wrote back in October of 2023. This is mostly for compatibility reasons with my current site, and also let's me memoize the fairly expensive mandelbulb vertices calculations.
