...
export default function SceneOverlay() {
  ...
  return (
    <Suspense>
      ...
      {!searchParams.get('screen') && (
        <>
          <div className='ctp-mocha pointer-events-none absolute z-[1] opacity-0 motion-safe:animate-fade-in motion-reduce:opacity-100 sm:left-4 sm:top-4 md:left-6 md:top-6 lg:left-10 lg:top-24'>
            <div className='w-fit'>
              ...
              {needHint ? (
                <div className='ctp-mocha overflow-hidden'>
                  <p className='font-mono text-sm font-bold text-ctp-text motion-safe:-translate-y-full motion-safe:animate-fade-in-down motion-safe:[animation-delay:3.8s]'>
