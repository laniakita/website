...
Command: npx gltfjsx@6.2.16 bot_neil_animation_by_oscar_creativo.glb --types --shadows --transform --resolution 512 --simplify --debug 
Files: bot_neil_animation_by_oscar_creativo.glb [8.11MB] > /home/lani/Development/ahiakea/apps/laniakita-com/public/assets/models/bot-neil/assets/models/bot-neil/bn-x512.glb [403.4KB] (95%)
...
export function Neilx512(props: JSX.IntrinsicElements['group']) {
...
useGLTF.preload('/assets/models/bot-neil/bn-x512.glb');
