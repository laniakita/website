...
Files: bot_neil_animation_by_oscar_creativo.glb [8.11MB] > website/apps/laniakita-com/public/assets/models/bot-neil/assets/models/bot-neil/bn-x256.glb [233.95KB] (97%)
...
export function Neilx256({ props, isPlay }: BotProps) {
	...
	const { nodes, materials, animations } = useGLTF(
		"/bot-clicker/assets/models/bot-neil/bn-x256.glb",
...
useGLTF.preload("/bot-clicker/assets/models/bot-neil/bn-x256.glb");
