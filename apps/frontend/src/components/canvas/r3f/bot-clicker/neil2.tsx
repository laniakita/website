...
import { Neilx256 } from "./models/bot-neil/x256";
import { Neilx512 } from "./models/bot-neil/x512";
...
function ZunSetup({ z, speed, index, viewMobile }: { z: number; speed: number; index: number; viewMobile: boolean }) {
	...
	const handleBotClick = (/*e: ThreeEvent<MouseEvent>*/): void => {
		...
		enum BotSounds {
			Friendly = "/bot-clicker/assets/audio/Pixel_54.wav",
			FriendlyCool = "/bot-clicker/assets/audio/Pixel_57.wav",
			FriendlyLong = "/bot-clicker/assets/audio/Pixel_64.wav",
		}
		...
		enum FilmCowSounds {
			BlehBlehBleh = "/bot-clicker/assets/audio/voice_-_bleh_bleh_bleh_blah.wav",
			Hmm = "/bot-clicker/assets/audio/voice_-_hmm_3.wav",
			OhNo = "/bot-clicker/assets/audio/voice_-_oh_no_4.wav",
			ThankYou = "/bot-clicker/assets/audio/voice_-_thank_you_2.wav",
			Wow = "/bot-clicker/assets/audio/voice_-_wow_4.wav",
		}
