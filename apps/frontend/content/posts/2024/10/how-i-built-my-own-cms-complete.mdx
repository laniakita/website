...
![Entity Relationship diagram showing 1:M (authors, featured_images), and M:M (tagSlugs). The latter made possible with a junction table (posts_to_tagSlugs)](../../../assets/images/oc/2024/10/cms-relations-diagram.jpg)
