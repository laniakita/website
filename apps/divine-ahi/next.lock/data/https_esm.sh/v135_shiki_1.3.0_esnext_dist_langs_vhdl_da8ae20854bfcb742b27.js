/* esm.sh - esbuild bundle(shiki@1.3.0/dist/langs/vhdl) esnext production */
var n=Object.freeze({displayName:"VHDL",fileTypes:["vhd","vhdl","vho","vht"],name:"vhdl",patterns:[{include:"#block_processing"},{include:"#cleanup"}],repository:{architecture_pattern:{patterns:[{begin:`(?x)
