...
import SocialIconNavSplitterUltra from '@/components/socialSplitterUltra';
const TextSplitterUltra = dynamic(() => import('@/components/textSplitterV2'), {
  ssr: true,
});
        ...
        {searchParams.get('screen') && (
          <div className='absolute  left-4 top-8  z-[1] w-fit text-xl  lg:top-20'>
            <Link
              ...
              onClick={() => needHint && setNeedHint(false)}
            >
              Back
            </Link>
          </div>
